...
/*@Aspect
@Component*/
public class AspectLogOutput {

    /**
     * 定义了一个切点
     * 这里的路径填自定义注解的全路径
     */
    @Pointcut("@annotation(com.example.springdemo.annotation.LogAuth)")
    public void authCut() {

    }

    @Pointcut("execution(public * com.example.springdemo.demos.web.*.*(..))")
    public void LogAuthCut() {
    ...
    public void cutProcess(JoinPoint joinPoint) {
        ...
        String vo = JSON.toJSONString(args);
        System.out.println("注解方式AOP开始拦截, 当前拦截的方法名: " + method.getName()+"获取入参:"+vo);
    }
    ...
    public void after(JoinPoint joinPoint) {
        ...
        Object[] args = joinPoint.getArgs();
        String vo = JSON.toJSONString(args);
        System.out.println("注解方式AOP执行的方法 :" + method.getName() + " 执行完了"+"获取入参:"+vo);
    }
